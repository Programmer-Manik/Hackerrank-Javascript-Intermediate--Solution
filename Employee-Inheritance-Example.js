...
// Engineer class definition that inherits from Employee
function Engineer(title, isManager) {
    Employee.call(this, title); // Inherit properties
    this.isManager = isManager; // Additional property specific to Engineer
}
